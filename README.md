...
| [Traffic Collision Analysis](https://github.com/raxitsoni-ai/eda-etl-traffic-collision-analysis) | Smart Cities & Public Safety | EDA, ETL & Visualization | pyspark, pandas, numpy, matplotlib, Seaborn, AWS S3, Power BI | Extract data-driven insights from large-scale records to help optimize the traffic management and accident reduction strategies. |
